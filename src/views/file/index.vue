...
// 获取上传处理hook
const { uploadLoading, uploadTaskList, cancelUploadTask, removeUploadTask, handleSubmit } = useFileUpload();
  ...
  <div class="transfer-container equal-height-flex">
    ...
    <div class="history-list-area">
      <ElCard shadow="hover" class="history-card">
        <FileList ref="fileListRef" @detail="handleShowDetail" @lineage="handleShowLineage" />
      </ElCard>
    </div>
