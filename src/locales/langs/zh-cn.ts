const local: App.I18n.Schema = {
  ...
  route: {
    ...
    task_home: '任务创建',
    taskunit: '任务单元',
    taskunit_list: '任务单元列表',
    taskunit_create: '任务单元创建',
    task_create: '任务参数配置',
    taskchain: '任务链',
    taskchain_list: '任务链列表',
    taskchain_create: '任务链创建',
    scene: '场景',
    scene_create: '场景配置',
    scene_home: '场景创建',
    scene_list: '场景列表',
  ...
  page: {
    ...
    home: {
      ...
      vcfFiles: 'VCF文件',
      fileTypes: '文件类型',
      fileTypesOverview: '文件类型分布',
      fileTypesDescription: '不同文件类型的数量统计',
      taskStatus: '任务状态',
      taskStatusOverview: '任务状态概览',
      taskStatusDescription: '各种类型任务的当前状态统计',
      taskPending: '等待中',
      taskRunning: '运行中',
      taskCompleted: '已完成',
      taskFailed: '失败',
    ...
    permission: {
      ...
      duration: '申请时长',
      durationPlaceholder: '请输入天数',
      durationUnit: '天',
      forever: '永久权限',
      reason: '申请理由',
      reasonPlaceholder: '请详细说明申请此权限的理由（最多500字）',
      reasonLength: '申请理由不能超过500字',
      durationRange: '申请时长需在1-365天之间',
      enterDuration: '请输入申请时长',
      enterReason: '请输入申请理由',
      applySuccess: '权限申请提交成功，请等待管理员审批',
      addSuccess: '权限添加成功',
      applicant: '申请人',
      userName: '用户名',
      ...
      rejectSuccess: '拒绝成功',
      revoke: '撤销',
      confirmRevoke: '确认撤销该权限吗？',
      revokeSuccess: '撤销成功',
      addPermission: '添加权限',
      currentPermission: '当前权限',
      historyPermission: '申请历史',
      createTime: '申请时间',
      withdraw: '撤回',
      permanent: '永久',
      active: '已通过',
      ...
      withdrawn: '已撤回',
      error: '错误',
      noPermissions: '您还没有任何权限',
      noPermission: '您没有{name}权限',
      noPermissionGuide: '您没有{name}权限，是否需要申请该权限？',
      adminNoNeedApply: '您已是管理员，无需申请权限',
      days: ' 天'
    }
  },
  form: {
