const local: App.I18n.Schema = {
  ...
  route: {
    ...
    task: 'Task',
    taskunit: 'task unit',
    taskunit_list: 'taskunit_list',
    taskunit_create: 'taskunit_create',
    taskchain: 'taskchain',
    taskchain_list: 'taskchain_list',
    taskchain_create: 'taskchain_create',
  ...
  page: {
    ...
    home: {
      ...
      fileTypesOverview: 'File Type Distribution',
      fileTypesDescription: 'Statistics of different file type quantities',
      taskStatus: 'Task Status',
      taskStatusOverview: 'Task Status Overview',
      taskStatusDescription: 'Current status statistics for various types of tasks',
      taskPending: 'Pending',
      taskRunning: 'Running',
    ...
    permission: {
      ...
      applyTitle: 'Apply Permission',
      applyDesc: 'Please select the permission type and fill in the application information',
      applyNow: 'Apply Now',
      ...
      genealogy: 'Genealogy Management',
      taskChain: 'Task Chain Management',
      taskUnit: 'Task Unit Management',
      admin: 'Admin Permission',
      permissionType: 'Permission Type',
      selectPermissionType: 'Select Permission Type',
      duration: 'Duration',
      durationPlaceholder: 'Enter days',
      durationUnit: ' days',
      forever: 'Permanent Permission',
      reason: 'Reason',
      reasonPlaceholder: 'Please explain why you need this permission (max 500 characters)',
      reasonLength: 'Reason must not exceed 500 characters',
      durationRange: 'Duration must be between 1-365 days',
      enterDuration: 'Please enter duration',
      enterReason: 'Please enter reason',
      applySuccess: 'Permission application submitted successfully. Please wait for admin review.',
      ...
      statusError: 'Error',
      review: 'Review',
      reviewTitle: 'Review Permission Application',
      ...
      historyPermission: 'Application History',
      ...
      withdrawn: 'Withdrawn',
      error: 'Error',
      noPermissions: 'You do not have any permissions',
      noPermission: 'You do not have {name} permission',
      noPermissionGuide: 'You do not have {name} permission. Do you want to apply for it?',
      adminNoNeedApply: 'You already have admin permission. No need to apply.',
      days: ' days'
    }
  },
  form: {
